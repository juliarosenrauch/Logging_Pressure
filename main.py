...
if __name__ == "__main__":
    ...
    while True:
        ...
        #
        # if dig1.get_dig_value():
        #     # here u have another if statement that only takes readings when the readings are above the baseline and then stops when they fall back to within a 0.1V range of the baseline
        ...
        #
        # else:
        #     # here u toggle the second switch and take like 100 measurements, average them, and that becomes your baseline
